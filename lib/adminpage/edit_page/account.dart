...
class _UpdatepageState extends State<Updatepage> {
  ...
  final TextEditingController _kodePerawatController = TextEditingController();
  ...
  Future<void> _fetchAccountData() async {
    try {
      ...
      setState(() {
        ...
        _kodePerawatController.text = account.kodePerawat;
  ...
  void _submitData() async {
    ...
    String kodePerawat = _kodePerawatController.text;
    ...
    try {
      await UpdateAccount.updateAccount(
        username, password, _selectedRole, phone, name, kodePerawat, widget.id);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _buildTextField(
                  controller: _kodePerawatController,
                  labelText: "kodePerawat",
