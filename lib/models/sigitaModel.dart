...
class UpdatePhoneProfile {
  Future<String?> updatePhone(String id, String phone) async {
    var url = Uri.parse("https://4h8dxjh2-3000.asse.devtunnels.ms/api/updatePhone/$id");
...
class UpdatePasswordProfile {
  Future<String?> updatePassword(String id, String password) async {
    var url = Uri.parse("https://4h8dxjh2-3000.asse.devtunnels.ms/api/updatePassword/$id");
    var hasilResponse = await http.patch(
      url,
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({
...
class GetUser {
  ...
  static Future<GetUser> getUser() async {
    ...
    var url = Uri.parse("https://4h8dxjh2-3000.asse.devtunnels.ms/api/identitas");
...
class LoginSigita {
  static Future<String?> login(String username, String password) async {
      ...
      final response = await http.post(
        Uri.parse('https://4h8dxjh2-3000.asse.devtunnels.ms/api/login'),
        headers: {'Content-Type': 'application/json'},
...
class GetSigita {
  ...
  static Future<List<GetSigita>> connApi(String id) async {
    Uri url = Uri.parse("http://4h8dxjh2-3000.asse.devtunnels.ms/api/getPostingan/$id");
    var hasilResponse = await http.get(url);
    var jsonData = jsonDecode(hasilResponse.body);
  ...
  static Future<GetSigita> connApiDetail(String id) async {
    Uri url = Uri.parse("http://4h8dxjh2-3000.asse.devtunnels.ms/api/getPostinganDetail/$id");
    var hasilResponse = await http.get(url);
    var jsonData = jsonDecode(hasilResponse.body);
...
class PostSigita {
  ...
  static Future<PostSigita> postSigita(
    ...
    Uri url = Uri.parse("https://4h8dxjh2-3000.asse.devtunnels.ms/api/simpanKomentar");
...
class GetFile {
  ...
  static Future<GetFile> getFile(String id) async {
    Uri url = Uri.parse("http://4h8dxjh2-3000.asse.devtunnels.ms/api/getDownloadFile/$id");
    var hasilResponse = await http.get(url);
    var jsonData = jsonDecode(hasilResponse.body);
...
class PermissionFile {
  ...
  static Future<PermissionFile> postDownload(
    ...
    Uri url = Uri.parse("https://4h8dxjh2-3000.asse.devtunnels.ms/api/downloadModul");
    var hasilResponse = await http.post(
      url,
      body: {
        "id_postingan": idPostingan,
...
class GetKategori {
  ...
  static Future<List<GetKategori>> getKategori() async {
    Uri url = Uri.parse("http://4h8dxjh2-3000.asse.devtunnels.ms/api/getKategori");
    var hasilResponse = await http.get(url);
    var jsonData = jsonDecode(hasilResponse.body);
    var dataList = jsonData["data"] as List;
    return dataList.map((user) {
...
class GetKomentar {
  ...
  static Future<List<GetKomentar>> getKomentar(String id) async {
    Uri url = Uri.parse("http://4h8dxjh2-3000.asse.devtunnels.ms/api/getKomentar/$id");
    var hasilResponse = await http.get(url);
    var jsonData = jsonDecode(hasilResponse.body);
    var dataList = jsonData["data"] as List;
    return dataList.map((user) {
